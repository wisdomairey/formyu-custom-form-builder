          ...
          <div className="grid grid-cols-1 gap-3 pl-2">
            {category.fields.map((fieldType) => (
              <button
                ...
                className="w-full p-4 text-left border border-gray-200 rounded-xl hover:border-blue-400 hover:bg-blue-50 transition-all duration-200 group hover:shadow-md bg-white hover:scale-[1.02] transform"
              >
                <div className="flex items-center space-x-3">
                  <div className="w-10 h-10 bg-gradient-to-br from-gray-100 to-gray-200 rounded-xl flex items-center justify-center group-hover:from-blue-100 group-hover:to-blue-200 transition-all duration-200 shadow-sm">
                    <span className="text-lg">{getFieldIcon(fieldType)}</span>
                  </div>
