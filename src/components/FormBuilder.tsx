      ...
      <div className="lg:hidden bg-white border-b border-gray-200 p-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-2">
            ...
            <h1 className="text-lg font-bold text-gray-800">FormYu</h1>
          </div>
          <div className="flex items-center space-x-2">
            <button
              type="button"
        ...
        <div className="p-4 border-b border-gray-200">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center space-x-2 hidden lg:flex">
              ...
              <h1 className="text-xl font-bold text-gray-800">FormYu</h1>
            </div>
              ...
              <div className="max-w-2xl mx-auto">
                <div className="mb-6">
                  <div className="flex items-center space-x-2 mb-2">
                    <Layout className="h-6 w-6 text-primary-600" />
                    <h2 className="text-xl lg:text-2xl font-bold text-gray-800">Build Your Form</h2>
                  </div>
