...
const FormBuilder: React.FC = () => {
  ...
  return (
    <div className="h-screen flex flex-col lg:flex-row bg-gray-50">
      ...
      <div className={`
        mobile-sidebar bg-white
        ${isSidebarOpen ? 'open' : 'closed'}
        ${isPreviewMode ? 'hidden lg:hidden' : 'lg:flex lg:flex-col lg:w-80'}
      `}>
        {/* Mobile overlay */}
        {isSidebarOpen && (
          <div 
        ...
        <div className="relative z-50 h-full bg-white overflow-y-auto">
          ...
          <>
            ...
            <div className="flex-1 p-6 overflow-y-auto">
              <div className="max-w-2xl mx-auto">
                <div className="mb-6">
                  <h2 className="text-2xl font-bold text-gray-800 mb-2">Build Your Form</h2>
